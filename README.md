...
#### Prototypeでの作業概要
1)Claudeさんに構築の戦略を相談、必要部品を教えてもらいパーツを購入
2)Claudeさんに聞きながら、ブレッドボードで XIAO nRF52840 と MCP23017 他を配線
- 2. ブレッドボード接続
3)Arduino IDE で XIAO nRF52840 と MCP23017 の動作確認。コードはClaudeさん提供
- 3. 接続確認プログラムと実行方法
4)Arduino IDE で キーマップ確認。確認用のコードはClaudeさん提供
- 4. キーマップ確認用プログラム
5)Claudeさんに ZMK GitHub ビルド用ソースの出力を依頼
- 5. ZMK GitHub ビルド用ソース
6)GitHubにソースを配置、ビルドおよび動作確認の試行錯誤
- 6. ZMK動作確認と試行錯誤の記録
- 7. 配線変更と動作確定
- 8. 追加機能実装
- 9. ゴーストキー問題と対策
